            ...
            <div class="box-content">
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="post" enctype="multipart/form-data" action="<?php echo U('upload/upload');?>" id="upload-form">
        ...
        $('#upload').click(function(){
            $('#upload-form').ajaxSubmit({
                ...
                success:function(data){
                    if(data.name){
                        $('.file-list').after('<li class="list-group-item"><i class="icon-remove"></i>'+data.name+'<input type="hidden" value="'+data.id+'" name="file_id[]"></li>');
                        $('#myModal').modal('hide');
                    }else{
                        $('.alert').html('<div class="alert alert-danger"><strong>错误!</strong>上传失败</div>')
                    }
                }
            })
        })
...
<script src="/myproject/Public/Admin/js/jquery.form.js" type="text/javascript"></script>
<!--
